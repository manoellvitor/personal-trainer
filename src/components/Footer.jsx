    ...
    <section className='text-slate-200 mt-10 p-4 gap-2 flex-wrap bg-[#1D1D20]'>
      <div className='lg:max-w-[1440px] md:flex md:justify-between mx-auto items-center'>
        ...
        <div className='flex gap-2 p-8 text-[#a8a8b3] mx-auto items-center justify-center'>
          <a href='#' className='hover:text-slate-200 transform ease-in-out duration-300'><FacebookLogo size={32} /></a>
          <a href='#' className='hover:text-slate-200 transform ease-in-out duration-300'><TwitterLogo size={32} /></a>
