  ...
  return (
    <div className='w-full md:h-[800px] h-[700px] shadow-sm shadow-slate-200 overflow-hidden flex flex-col items-center justify-center'>
      ...
      <div className='flex flex-col justify-center items-center w-full h-full gap-4 md:max-w-2xl z-[1]'>
        <h1 className='text-white uppercase text-3xl font-bold text-center leading-10'>You don't have to be great to start, but you have to start to be great.</h1>
        <p className='text-white text-center'>Champions aren't made in the gyms. Champions are made from something they have deep inside them, a desire, a dream, a vision.</p>
